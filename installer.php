...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Wordpress_ThomasDaCosta_voyage_64c10a83d3a447d63407_20220329105414_archive.zip';
	const ARCHIVE_SIZE		 = '75156334';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '64c10a8-29105414';
    const SECONDARY_PACKAGE_HASH = '2c0a00f-29105414';
	const VERSION			 = '1.4.4';
